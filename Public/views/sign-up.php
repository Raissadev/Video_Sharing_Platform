<section class="container-auth w100 h100vh items-flex align-center just-center">
    <form method="POST" action="<?= BASE_URL ?>/sign-up" enctype="multipart/form-data" class="form-box items-flex flex-wrap align-center w50">
        ...
        <button type="submit" name="sign-up" class="button-default w20 center">Sign Up</button>
